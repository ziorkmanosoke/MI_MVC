                            ...
                            <article class="box">
                                <article class="box-blanc alignleft">
                                    <div class="icon"><!--Debut icon pour particulier-->
										...
										<article class="box"><!--Debut des choix pour les forfaits pour les particuliers-->
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" >
												<input type="hidden" name="cmd" value="_s-xclick">
												<table>
												<tr  class="forfait"><td><input type="hidden" name="on0" value="Les Forfaits">Les Forfaits Particuliers</td></tr><tr><td><select name="os0">
													<option value="La Base">La Base $75.00 CAD</option>
													<option value="Le Regulier">Le Regulier $150.00 CAD</option>
													<option value="Le Premium">Le Premium $300.00 CAD</option>
												</td></tr>
												</table>
										...
										</article><!--Fin des choix pour les forfaits pour les particuliers-->
